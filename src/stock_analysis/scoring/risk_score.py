...
def _explain(sub: dict, f: dict) -> str:
    ...
    if ic     is not None: parts.append(f"Int. coverage: {ic:.1f}x")
    if pledge is not None: parts.append(f"Pledge: {pledge:.1f}%")
